    ...
    <div className="min-h-screen bg-cream">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-4">
            <span
              ...
              style={{ backgroundColor: 'rgba(198,167,94,0.2)', color: '#C6A75E' }}
            >
          ...
          {cardKeys.map((key, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm leading-relaxed" style={{ color: 'rgba(15,61,46,0.7)' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div
          ...
          style={{ backgroundColor: 'rgba(15,61,46,0.05)', border: '1px solid rgba(15,61,46,0.12)' }}
        >
